  ...
  function search(event) {
    if (event.target.value == "") {
      ...
      Object.keys(Data1).map(function (key) {
        if (
          Data1[key].Title.match(event.target.value) ||
          Data1[key].Discription.match(event.target.value)
        ) {
          obj[key] = Data1[key];
        }
      });
  ...
  return (
    <div>
      ...
      <div className="inputBox">
        ...
        />
        <br />
        <button type="button" id="contactBtn" onClick={save}>
          Save
        </button>
      </div>
      <div>
              ...
              {Object.keys(Data).map(function (key, index) {
                return (
                  <tr key={key}>
                    ...
                    <td>
                      {Data[key].Discription ? Data[key].Discription : ""}
                    </td>
                  </tr>
                );
              })}
